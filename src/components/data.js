    ...
    sections: [
      {
        ...
        content: 'I\'m a professional web development, long time ago I started to interest in web tecnologies and today I become a profesional web developer. In my career I made lots of systems that helped the people to do the things easier. ',
        icon: 'usertie'
      },
      {
        type: 'common-list',
        ...
        items: [
          {
            title: 'Computer Engineering (IPN-ESIME)',
        ...
        items: [
          {
            title: 'Senior Web Developer',
            company: 'Ironbit',
            description: 'In claro video I\'m using React js, SASS, webpack, Charles proxy and other tools to connect the app with STB(Set Up Boxes), STV (Smart TV) and video consoles like PS4. To update the code, we integrate functional components created with typescript and I made some configuratios to reduce the bundle size, all of this configurations help us to make easier run the app in old smart tv\'s and make the app faster. I worked with the music middleware created apis to show information about artist, albums and songs. Actually I development new features base on briefs created by the user.',
          ...
          },
          {
            ...
            description: 'I was working on some videogames made with unity 3D and C#/javascript like programming languaje to GLADKIDS local also made virtual tours for clients like GNP and made the website of Matersys.',
          ...
          },
          {
            ...
            description: 'I made projects interns that we are planing, I participated making augmented reality, mobile apps and some games with javascript(corona).',
      ...
      },
      {
        ...
        items: [
          {
            authority: 'English',
            authorityMeta: 'Technical intermediate'
          }
        ]
      },
      {
